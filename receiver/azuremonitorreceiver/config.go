...
type Config struct {
	...
	//TODO: resources def does not mean anything. This is "metrics" definition. Shall we make a breaking change
	CacheMetricsDefinitions           float64          `mapstructure:"cache_resources_definitions"`
